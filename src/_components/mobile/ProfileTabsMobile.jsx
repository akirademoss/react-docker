...
class ProfileTabsMobile extends React.Component {
    render() {
        const { classes, tab, handleTabChange } = this.props;
...
export default (withStyles(styles, { withTheme: true })(ProfileTabsMobile));;