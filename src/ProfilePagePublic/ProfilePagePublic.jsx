...
// Profile page class
class ProfilePagePublic extends React.Component {
    constructor(props) {
        super(props);
...
export default connect(mapStateToProps, actionCreators)(withStyles(styles, { withTheme: true })(ProfilePagePublic));